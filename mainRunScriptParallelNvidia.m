...
funcNames = arrayfun(@(x) ['F' num2str(x)], 27:30, 'UniformOutput', false);
...
pool = parpool('local', 1, 'AttachedFiles', {'OriginalSolo.m', 'ModifiedSolo.m', 'CreateInitialShares.m', 'CEC2014.m', 'DumpAndPump.m', 'Exchange.m', 'Falling.m', 'GenerateNewShare.m', 'ModifiedCreateInitialShares.m', 'PumpAndDump.m', 'ModifiedRising.m', 'ModifiedExchange.m', 'ModifiedFalling.m', 'ModifiedGenerateNewShare.m'});
